...
pals.push(new Pal("Lucy Van Pelt", "data/photos/Lucy_van_Pelt.png", [5, 1, 4, 4, 5, 1, 2, 5, 4, 1]));
pals.push(new Pal("Charlie Brown", "/data/photos/Charlie_Brown.png", [3, 1, 3, 2, 5, 1, 2, 5, 3, 3]));
...
console.log("my 3rd pal in friends.js " + pals[2].name);
